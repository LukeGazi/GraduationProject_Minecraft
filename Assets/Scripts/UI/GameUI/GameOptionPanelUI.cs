...
public class GameOptionPanelUI : MonoBehaviour {
    ...
    private void Awake() {
        ...
        NoticeManager.Instance.Register( StrManager.GAME_OPTION_PANEL_SHOW_NOTICE, ShowPanel );
        NoticeManager.Instance.Register( StrManager.GAME_OPTION_PANEL_HIDE_NOTICE, HidePanel );
